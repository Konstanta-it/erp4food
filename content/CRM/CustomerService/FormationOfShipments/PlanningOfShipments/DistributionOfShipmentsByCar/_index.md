...
- [Склад](https://konstanta-it.github.io/erp4food/CommonInformation/Warehouse) (так же может использоваться группа складов, тогда к распределению попадут *"Планы отгрузок"* со всех складов из группы)
- [Зона](https://konstanta-it.github.io/erp4food/CommonInformation/ZoneOfDelivery)
- Дата
...
2. *Распределение планов отгрузки по машинам*
    ...
    Кнопкой **->>** *"Планы отгрузки"* распределяются по машинам по [**"Шаблонам рейсов"**](https://konstanta-it.github.io/erp4food/CommonInformation/TemplateRoute).
