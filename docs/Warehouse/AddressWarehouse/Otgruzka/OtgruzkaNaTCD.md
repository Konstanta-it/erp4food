...
Также распоряжение на отбор может быть сформировано автоматически регламентным заданием Формировать распоряжения на отбор по настройкам [склада](../../../CommonInformation/Warehouse.md) с учетом констант Проверять остаточный срок годности и Кол-во дней для формирования распоряжений на отбор в Настройках склада и доставки.
