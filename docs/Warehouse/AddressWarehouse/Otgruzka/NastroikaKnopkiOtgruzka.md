...
- При активной опции "Проверка сканируемой номенклатуры" доступна опция "Свободный порядок сканирования" (Возможность сканировать номенклатуру из РнП в любом порядке)
