...
-   *Распределить материалы* - При выборе данной операции на рабочем центре будут списываться все остатки сырья и полуфабрикатов, пошедших на выпуски в рамках смены. При выполнении операции будет создан документ Распределение материалов.  Если данная операция не выбрана, все работает исходя из типового функционала.

-   *Формирование перемещений* - При выборе данной операции появляется дополнительная настройка, позволяющая указать направления перемещений (Отправитель-Получатель). Так при закрытии смены будет создаваться документ "Перемещение товаров" для каждого выбранного направления на основании РнП за текущую смену на данном РЦ. Данная операция доступна при активной функциональной опции "Формировать итоговые документы за смену".

-   *Формирование акта переработки* - После успешного закрытия смены будет автоматически сформирован документ "Акт Переработки". Данная операция доступна при активной функциональной опции "Формировать итоговые документы за смену".
