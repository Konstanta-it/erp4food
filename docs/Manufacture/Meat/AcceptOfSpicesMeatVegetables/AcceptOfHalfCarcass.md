...
- Вводим количество номенклатуры в килограммах и штуках, срок годности (берется из карточки номенклатуры), дату изготовления и номер партии сырья. Если в настройках кнопки учетной точки указана опция "Автоматическое формирование номера партии", тогда номер партии будет сформирован автоматически, указывать его не требуется.
...
В последнем поле есть возможность указать количество этикеток партии к печати.
...
В случае, если в параметрах настройки кнопки активирована функция "Печатать Акт расхождения", соответствующий документ автоматически отобразится в режиме предварительного просмотра для печати. Если данная опция деактивирована, документ будет создан в системе, но не будет выведен на печать.
