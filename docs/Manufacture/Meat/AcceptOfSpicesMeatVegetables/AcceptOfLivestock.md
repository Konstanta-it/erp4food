...
- Вводим количество номенклатуры в килограммах, срок годности в днях, дату изготовления и номер партии. Если в настройках кнопки учетной точки указана опция "Автоматическое формирование номера партии", тогда номер партии будет сформирован автоматически, указывать его не требуется.
...
![](AcceptOfLivestock.assets/14.png)
