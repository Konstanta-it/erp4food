...
Пример - [работа с заданиями на сквашивание полуфабрикатов](../../../../Fermentation/TaskForShift/TaskForShift.md).
...
|-----|-----|-----|------|
| Выполнять наборку по рецептуре | Под каждую строку задания осуществляется наборка ингредиентов по спецификации | Завершать выпуск | Включен - при завершении наборки    формируется документ "Переработка" в статусе "Выполнено" <br> Количество выпускаемой продукции = общему весу указанных в наборке ингредиентов <br> Не включен - статус "Начато", количество выпуска и склад не заполняются |
