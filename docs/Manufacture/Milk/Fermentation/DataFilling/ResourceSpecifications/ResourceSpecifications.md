...
Каждую ресурсную спецификацию можно распечатать полностью или только конкретный этап. Сделать это можно несколькими способами. 

Для того, чтобы полностью распечатать ресурсную спецификацию, необходимо открыть форму списка всех спецификаций, выбрать по строке необходимую и нажать печать "Этапы спецификации":

![](ResourceSpecifications.assets/2.png)

![](ResourceSpecifications.assets/3.png)

Печать конкретного этапа спецификации можно выполнить из форм "Работа со спецификацией" и "Стандартная". Для этого необходимо открыть саму спецификацию, выбрать этап и нажать печать "Этапы спецификации":
