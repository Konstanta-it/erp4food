...
- Печатать штрихкод паллеты: да/нет; 
- Маркировка штуки: штука/короб.

Данные параметры дублируют указанные в настройках кнопки учетной точки, однако их можно изменить в рамках текущего сеанса. При перезапуске обработки все параметры примут исходные значения.

![3](StacMark.assets/3.png)

На вкладке **"Маркировка"** отображаются строки **Производственного задания**. Каждая строка это номенклатура с выбранными параметрами для маркировки. Если производственных заданий несколько, то на форме отобразятся строки каждого задания.
...
3. После того как будет введена информация по всей выпускаемой продукции, нажимаем на кнопку **"Завершить"**. Будет сформирован документ **"Переработка"**. Если активна опция в настройках "Печатать штрихкод паллеты", то по завершению также будет распечатан Упаковочный лист на основании макета, указанного в Настройках Кнопки учетной точки.
