...
- Указывается будут ли создаваться Упаковочные листы в результате работы, если да то еще заполняется поле *Макет*(Упаковочный лист). Если данная опция активна, то в настройках самого АРМа появится дополнительная настройка печати Упаковочного листа по результатам выпуска;
