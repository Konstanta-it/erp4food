...
Отчет **"План-факт по поставкам"** - позволяет просматривать плановые и фактические значения по документам "Поступление товаров и услуг" за выбранный период. 
