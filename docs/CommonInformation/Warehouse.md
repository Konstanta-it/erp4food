...
- Признак [упрощенного адресного склада](../Warehouse/AddressWarehouse/LightAdressWarehouse.md)
- Дата  начала адресного хранения остатков  
- Ячейка приемки
- Ячейка отгрузки
- Ячейка пересчета (доступно для обычного адресного склада)
- Ячейка тары (доступно для обычного адресного склада)
- Зона активного отбора (доступно для обычного адресного склада)
- Настройка Учитывать остатки (доступно для упрощенного адресного склада). При выключенной настройке Распоряжения на перемещения с типом Отбор формируются без заполненных партий и ячеек
- Настройка Автоматически формировать распоряжение на отбор (формирование документа Распоряжение на перемещение с типом Отбор регламентным заданием)  
    - Разделять по ячейкам (доступно для обычного адресного склада). Для каждой ячейки отправителя формируется свое Распоряжение на перемещение
- Правило размещения номенклатуры (доступно для обычного адресного склада):
    - Свободные
    - Политоварные
    - Монотоварные
...
![adress](Warehouse.assets/adress.png)  
![lightAdress](Warehouse.assets/lightAdress.png)
