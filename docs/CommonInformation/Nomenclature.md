...
- Признак Скоропортящейся продукции. При активации данного признака появляется возможность указывать срок годности в часах. Также у партии данной продукции реквизит "Годен до" заполняется в момент выпуска с учетом срока годности в часах.
- Срок годности
